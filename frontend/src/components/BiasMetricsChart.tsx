    ...
    <div className="card-wrapper" style={{height: '350px'}}>
      ...
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={data}>
          ...
          <Line type="monotone" dataKey="icd_score" name="Individual Disparity" stroke="var(--accent-yellow)" strokeWidth={2} dot={false} />
          <Line type="monotone" dataKey="dpd_score" name="Demographic Parity" stroke="var(--accent-green)" strokeWidth={2} dot={false} />
        </LineChart>
      </ResponsiveContainer>
    </div>
  );
